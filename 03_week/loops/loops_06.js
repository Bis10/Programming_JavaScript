...
wantToContinue = prompt("Do ypu want to continue giving numbers? (y/n):");
if(wantToContinue.toLowerCase == 'n')
break;
}
console.log(`The average of all input numbers is: ${(sumOfNumbers / amountofNumbers).toFixed(4)} (${sumOfNumbers} / ${amountofNumbers})`);
